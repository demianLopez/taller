...
b2Contact* b2EdgeAndPolygonContact::Create(b2Fixture* fixtureA, int32,
...
void b2EdgeAndPolygonContact::Evaluate(b2Manifold* manifold,
	...
	b2CollideEdgeAndPolygon(manifold, (b2EdgeShape*) m_fixtureA->GetShape(),
			xfA, (b2PolygonShape*) m_fixtureB->GetShape(), xfB);
}
