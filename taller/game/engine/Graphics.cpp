...
void Graphics::drawImage(Image * image, int xo, int yo, int txo, int tyo,
		int tdx, int tdy, int dx, int dy) {
...
void Graphics::drawAnimation(Animation * animation, int xo, int yo, int dx,
		int dy) {
...
void Graphics::drawFillPolygon(short int* vx, short int* vy, int n, int r,
		int g, int b) {
